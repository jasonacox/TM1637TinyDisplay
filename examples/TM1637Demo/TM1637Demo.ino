...
// Uncomment the following if you are running a small memory controller (e.g. ATtiny85) 
// #define TINYMEMORY
...
const uint8_t ANIMATION3[218][4] = {
  { 0x08, 0x00, 0x00, 0x00 },  // Frame 0
...
void loop() {
  ...
  display.clear();
#ifndef TINYMEMORY   
  display.showAnimation(ANIMATION1, FRAMES(ANIMATION1), TIME_MS(50));
  delay(2000);
#endif
  display.showAnimation(ANIMATION2, FRAMES(ANIMATION2), TIME_MS(50));
  delay(2000);
#ifndef TINYMEMORY

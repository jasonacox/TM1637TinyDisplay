...
#ifndef __TM1637TINYDISPLAYB__
#define __TM1637TINYDISPLAYB__
...
class TM1637TinyDisplayB {

public:
  //! Initialize a TM1637TinyDisplayB object, setting the clock and
  //! data pins.
  //!
  ...
  TM1637TinyDisplayB(uint8_t pinClk, uint8_t pinDIO, unsigned int bitDelay = DEFAULT_BIT_DELAY, 
  ...
  //! Create and retrun a copy the digitsbuf[]
  //!
